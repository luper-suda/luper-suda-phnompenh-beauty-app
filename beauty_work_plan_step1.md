...
- **1차 획득 (Dorking)**: `ddgs` 차단 면역 Python SDK 기반 키워드 탐색으로 492개 후보 샵 발굴.
- **2차 연쇄 그래프 추적 (BFS Depth 2)**: 페이스북/틱톡 프로필 하단 "유사 추천 샵 (Suggested Pages)" 연쇄 추적으로 473개 100% 검증 실존 뷰티 샵 마스터 등록.
- **4-Step 연락처 & 도로명 주소 확장**:
